...
[_QWERTY] = LAYOUT(
  ...
  KC_CAPS,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L,    DE_ODIA,  KC_NUHS,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,     LOWER,    RAISE,    KC_N,    KC_M,    KC_COMM, KC_DOT,  DE_MINS,  KC_RSFT,
                             KC_LCTRL, KC_LGUI,KC_NUBS, KC_SPC,   KC_ENT, KC_NUBS, KC_CAPS,    KC_LALT
),

[_LOWER] = LAYOUT(
  KC_F15 , KC_F16 , KC_F17 , KC_F18 , KC_F19 , KC_F20 ,                   _______, KC_F10 , KC_F11 , KC_F12 , _______, _______,
...
[_RAISE] = LAYOUT(
  KC__MUTE,KC_MPLY, KC_MPRV, KC_MNXT, KC__VOLDOWN,KC__VOLUP,                _______,  KC_F10 , KC_F11 , KC_F12 , _______, _______,
   KC_GRV, _______, _______, _______, _______, _______,                     _______,  KC_F7  , KC_F8  , KC_F9  , _______, _______,
  _______, _______, _______, _______, _______, _______,                     _______,  KC_F4  , KC_F5  , KC_F6  , _______, _______,
  _______, _______, _______, _______, _______, _______,  _______, _______,  _______,  KC_F1  , KC_F2  , KC_F3  , _______, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
